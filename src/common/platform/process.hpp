...
#define CONTEXT_CONTROL_32          (CONTEXT_X86    | 0x1L)
#define CONTEXT_CONTROL_64          (CONTEXT_AMD64  | 0x1L)
#define CONTEXT_INTEGER_32          (CONTEXT_X86    | 0x2L)
#define CONTEXT_INTEGER_64          (CONTEXT_AMD64  | 0x2L)
#define CONTEXT_SEGMENTS_32         (CONTEXT_X86    | 0x4L)
#define CONTEXT_SEGMENTS_64         (CONTEXT_AMD64  | 0x4L)
#define CONTEXT_FLOATING_POINT_32   (CONTEXT_X86    | 0x8L)
#define CONTEXT_FLOATING_POINT_64   (CONTEXT_AMD64  | 0x8L)
#define CONTEXT_DEBUG_REGISTERS_32  (CONTEXT_X86    | 0x10L)
#define CONTEXT_DEBUG_REGISTERS_64  (CONTEXT_AMD64  | 0x10L)
#define CONTEXT_XSTATE_32           (CONTEXT_X86    | 0x20L)
#define CONTEXT_XSTATE_64           (CONTEXT_AMD64  | 0x20L)
...
struct EXCEPTION_RECORD
{
    ...
    EMULATOR_CAST(typename Traits::PVOID, struct EXCEPTION_RECORD *)  ExceptionRecord;
...
{
    EMULATOR_CAST(typename Traits::PVOID, EXCEPTION_RECORD*) ExceptionRecord;
...
typedef struct _GROUP_AFFINITY64
{
    ...
    WORD Group;
    WORD Reserved[3];
} GROUP_AFFINITY64, *P_GROUP_AFFINITY64;
...
typedef struct _SYSTEM_NUMA_INFORMATION64
{
    ...
    union
    {
        GROUP_AFFINITY64 ActiveProcessorsGroupAffinity[MAXIMUM_NODE_COUNT64];
